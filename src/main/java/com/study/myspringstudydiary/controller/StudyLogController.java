...
public class StudyLogController {
     ...
     *
     * @return 오늘 작성한 학습 일지 목록
     */
    @GetMapping("/today")
    public ResponseEntity<ApiResponse<List<StudyLogResponse>>> getTodayStudyLogs() {

        List<StudyLogResponse> responses = studyLogService.getTodayStudyLogs();
        return ResponseEntity.ok(ApiResponse.success(responses));
    }
