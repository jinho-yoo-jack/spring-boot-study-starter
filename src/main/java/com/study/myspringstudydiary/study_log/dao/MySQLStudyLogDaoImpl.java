...
/**
 * MySQL based StudyLog DAO implementation with Lombok
 *
 * JdbcTemplate usage:
 ...
 *
 * @Slf4j - Provides log variable for logging
...
public class MySQLStudyLogDaoImpl implements StudyLogDao {
     ...
     * Using Builder pattern with Lombok
     */
    private final RowMapper<StudyLog> studyLogRowMapper = (rs, rowNum) ->
        StudyLog.builder()
            ...
            .understanding(Understanding.valueOf(rs.getString("understanding")))
    ...
    public StudyLog save(StudyLog studyLog) {
        log.info("Saving study log: {}", studyLog.getTitle());
        ...
        if (generatedId != null) {
            ...
            log.info("Study log saved with ID: {}", generatedId.longValue());
        }
